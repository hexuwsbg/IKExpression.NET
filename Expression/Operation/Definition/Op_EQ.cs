...
namespace Expression.Operation.Definition
{
    ...
    /// 逻辑等
    /// </summary>
    public class Op_EQ : IOperatorExecution
    {
        public static Operator THIS_OPERATOR = Operator.EQ;
        ...
        public Constant Execute(Constant[] args)
        {
            ...
            else
            {
                ...
                {
                    bool firstValue = first.GetBooleanValue();
                    bool secondValue = second.GetBooleanValue();
                    //if (firstValue != null)
                    //{
