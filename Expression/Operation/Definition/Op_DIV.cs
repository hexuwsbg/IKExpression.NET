...
namespace Expression.Operation.Definition
{
    ...
    /// 算术除
    /// </summary>
    public class Op_DIV : IOperatorExecution
    {
        public static Operator THIS_OPERATOR = Operator.DIV;
        ...
        public Constant Execute(Constant[] args)
        {
            ...
            else if (0.CompareTo(second.GetDoubleValue()) == 0)
            {
                //判断除数为0
                throw new ArgumentException("操作符\"" + THIS_OPERATOR.Token + "\"除数为零");
